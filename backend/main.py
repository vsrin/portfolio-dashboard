...
ASSET_CLASSES = [
    ...
    # ── Alternatives ──────────────────────────────────────────────────────────
    {
        ...
        "top": [("GLDM",69.41)],
        "worst": [],
        "holdings": [{"symbol":"GLDM","name":"SPDR Gold MiniShares","value":47313.45,"gain":18497.40,"return_pct":69.41}],
    },
    {
        "id": "hedged_equity",
        ...
        "top": [],
        "worst": [("BIVIX",-5.75)],
        "holdings": [{"symbol":"BIVIX","name":"Invenomic Institutional","value":76287.86,"gain":-10672.99,"return_pct":-5.75}],
    },
    {
        "id": "managed_futures",
    ...
    },
    {
        ...
        "weight": 26.16,
        "income": 0.0,
        "top": [("JPMorgan PM",18.95),("CAZ GP",13.71),("NorthHaven PE",11.40)],
        "worst": [("CAZ Sports",0.0),("Hamilton Lane VC",0.0)],
        "holdings": [
            {"symbol":"VISTAONETELP","name":"VistaOne (TE), L.P.-A-I","value":259679.44,"gain":9679.44,"return_pct":4.82},
            {"symbol":"CAZGPOCFTEL","name":"CAZ GP Ownership Class F Fund","value":111884.71,"gain":9384.71,"return_pct":13.71},
            {"symbol":"48130F306","name":"JPMorgan Private Markets Fund Cl I","value":118945.51,"gain":18945.51,"return_pct":18.95},
            {"symbol":"STEPSTONE","name":"StepStone Private Venture & Growth","value":75968.30,"gain":968.30,"return_pct":1.29},
            {"symbol":"NORTHHAVIII","name":"North Haven PE Co-Investment","value":36850.00,"gain":2918.00,"return_pct":11.40},
    ...
    # ── Cash & Other ──────────────────────────────────────────────────────────
    {
        ...
        "worst": [],
        "holdings": [
            {"symbol":"FDRXX","name":"Fidelity Cash Reserves","value":117382.80,"gain":12492.71,"return_pct":8.35},
            {"symbol":"FCASH","name":"Cash","value":-7.81,"gain":0.0,"return_pct":0.0},
        ],
    },
    {
        "id": "venture",
